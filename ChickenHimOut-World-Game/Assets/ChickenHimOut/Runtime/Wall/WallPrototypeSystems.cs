...
namespace ChickenHimOut.WorldGame.Wall
{
    ...
    public sealed class WallPanelSystem : MonoBehaviour
    {
        ...
        public void Brace() { if (State == PanelState.Aligned) SetState(PanelState.Braced); }
        public void ConfirmPhotoStable() { if (State == PanelState.Braced) SetState(PanelState.PhotoStable); }
